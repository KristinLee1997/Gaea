...
import com.aries.user.gaea.utils.PropertiesUtils;
...
public class MySqlSessionFactory {
    ...
    private static Configuration getConfiguration(String databaseName) {
        ...
        configuration.addMappers("com.aries.user.gaea.mapper");
    ...
    private static DataSource getHikariCpDatasource(String databaseName) {
        ...
        config.setIdleTimeout(600000);//个连接idle状态的最大时长（毫秒），超时则被释放（retired），缺省:10分钟
