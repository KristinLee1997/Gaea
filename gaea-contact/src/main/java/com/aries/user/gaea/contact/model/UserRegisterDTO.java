...
public class UserRegisterDTO implements org.apache.thrift.TBase<UserRegisterDTO, UserRegisterDTO._Fields>, java.io.Serializable, Cloneable, Comparable<UserRegisterDTO> {
    ...
    private static final org.apache.thrift.protocol.TField IMAGE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("imageId", org.apache.thrift.protocol.TType.I64, (short) 9);
    ...
    private static final _Fields optionals[] = {_Fields.ACCOUNT, _Fields.PHONE_NUMBER, _Fields.EMAIL, _Fields.PASSWORD, _Fields.WECHAT, _Fields.QQ, _Fields.IMAGE, _Fields.IMAGE_ID, _Fields.NICKNAME};
    ...
    public UserRegisterDTO setImageId(long imageId) {
